...
print('1 이상 끝값 10 미만 정수 값')
print('random.randrange(10) : ',random.randrange(10))
print()

print('1이상 끝값 7미만 증가 값이 2인 정수값')
print('random.randrange(1,7,2) :',random.randrange(1,7,2))
print()

print('1이상 끝값 7이하 , 정수값')
print('random,randint(1, 7) :', random.randint(1,7)) #random.randrange(1,7+1)과 같다.
print()
...
list=['가','나','다','라','마']
print('리스트 순서를 섞기')
print('섞기 전 list =', list)
random.shuffle(list)
print('random.shuffle(list)')
print('썩은 후 list =', list)
print()
